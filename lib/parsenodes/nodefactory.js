...
define("nodefactory", function () {
    ...
    var exports = {};
    builder.program = function program(body, strict, loc, extras) {
        return {
            type: "Program",
            body: "body",
            strict: strict,
    ...
    builder.variableDeclarator = function variableDeclarator(id, init, loc, extras) {
        return {
    ...
    builder.lexicalDeclaration = function variableDeclaration(kind, declarations, loc, extras) {
        return {
    ...
    builder.variableDeclaration = function variableDeclaration(kind, declarations, loc, extras) {
        return {
    ...
    builder.functionDeclaration = function functionDeclaration(id, formals, body, strict, loc, extras) {
        return {
