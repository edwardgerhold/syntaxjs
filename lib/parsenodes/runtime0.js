/*
    ...
    this is a copy of runtime.js

    it is for developing

    i don´t create a branch
    i can´t merge branches

    no, i tried not

    anyways, runtime.js has to be deleted,
    because it´s bad anyways,
    so i can do that quickly in my master

    nobody cares...


    goal: replace recursive Evaluate
    with loop() which pops from code stack
    and pushes onto operand stack.

 */


define("runtime0", function () {
//    function makeRuntime() {
    ...
    /*
     broken assignment with runtime.js
    */
...
//        if (tailPosition) {}
    ...
    function YieldExpression(completion) {
    ...
    function ConditionalExpression () {  // (node) entfaellt
