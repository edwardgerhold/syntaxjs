...
//
    ...
    function Literal() {
        ...
        if (IsAnyLiteral[t]) {
            ...
            if (notify) return notifyObservers(node); return node;
        }
        return null;
    }
    ...
    function PropertyKey() {
        ...
        if (node) if (notify) return notifyObservers(node); return node;
...
*/
    ...
    function Expression(stop, parenthesised) {
        ...
        default:
            ...
            else if (notify) return notifyObservers(node); return node;
        }
    }
    ...
    function BreakStatement() {
        if (v === "break") {
            ...
            pass("break");
            if (v !== ";") {
                if (ltNext) if (notify) return notifyObservers(node); else return node;
                if (t === "Identifier") {
                    var id = this.Identifier();
                    node.label = id.name;
                }
