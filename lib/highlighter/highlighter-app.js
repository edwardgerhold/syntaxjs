    ...
    define("highlight-gui", function (require, exports) {
        ...
        function setLanguage(lang) {
            ...
            if (pack && typeof pack === "object") {
                ...
                if (!pack.classAnnotations) throw new TypeError(format("S_MISSING_IN_PACK_S", "classAnnotations", lang));
                classAnnotations = pack.classAnnotations;

                if (!pack.annotations) throw new TypeError(format("S_MISSING_IN_PACK_S", "annotations", lang));
                annotations = pack.annotations;

                if (!pack.buttonNames) throw new TypeError(format("S_MISSING_IN_PACK_S", "buttonNames", lang));
                buttonNames = pack.buttonNames;

            } else {
                throw new TypeError(format("PACK_MISSING_S", lang));
            }
        }

        function selectLanguageEvent(e) {
         ...
         *
         * and the parentSelector tells the parentNode for the button´s container
         *
        ...
        function addLanguageButton(parentSelector) {
            ...
            if (parent) {
                ...
                button.onclick = selectLanguageEvent;
        ...
        function startHighlighterOnLoad(lang) {
            var config;
        ...
        exports.setHighlighterLanguage = setLanguage;
