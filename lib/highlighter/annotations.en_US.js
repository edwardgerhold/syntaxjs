define("annotations.en_US", function (require, exports) {
    ...
    // i use them in highlighter-app for mouseovers and button names
    // ClassNames is used, if annotations can not match the value to
    // give a generic information by the classname.

    // soon the highlighter will use the ast, and it will expand with
    // nodenames
