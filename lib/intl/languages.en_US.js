 ...
 *
 * Other possibilites to use the language pack is to call translate("KEY")
...
define("languages.en_US", function (require, exports) {
    ...
    exports.S_MISSING_IN_PACK_S = "%s missing in language pack %s";
    exports.MISSING_PACK_S = "no language pack for %s";
