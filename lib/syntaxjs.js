...
define("syntaxjs", function () {
    ...
    var syntaxerror_public_api_readonly = {
        ...
        readFile: pdmacro(require("syntaxerror-file").readFile),
        readFileSync: pdmacro(require("syntaxerror-file").readFileSync),
    ...
    var syntaxerror_highlighter_api = {
        highlight: pdmacro(require("syntaxerror-highlight"))
    };
    ...
    if (typeof window == "undefined" && typeof self !== "undefined" && typeof importScripts !== "undefined") {
        ...
        syntaxerror_highlighter_api.highlightElements = pdmacro(require("syntaxerror-highlight-gui").highlightElements),
        syntaxerror_highlighter_api.startHighlighterOnLoad = pdmacro(require("syntaxerror-highlight-gui").startHighlighterOnLoad)
