...
function thisStringValue(value) {
    ...
    if (Type(value) === OBJECT && hasInternalSlot(value, SLOTS.STRINGDATA)) {
        var b = getInternalSlot(SLOTS.STRINGDATA);
...
var StringConstructor_call = function Call(thisArg, argList) {
    ...
    if (Type(O) === OBJECT && hasInternalSlot(O, SLOTS.STRINGDATA) && getInternalSlot(SLOTS.STRINGDATA) === undefined, O) {
        var length = s.length;
        ...
        setInternalSlot(SLOTS.STRINGDATA, O, s);
        return O;
    }
    return s;
};
...
var StringConstructor_$$create = function (thisArg, argList) {
    ...
    setInternalSlot(SLOTS.PROTOTYPE, obj, proto);
    setInternalSlot(SLOTS.STRINGDATA, obj, undefined);
    return obj;
}
...
var StringConstructor_call = function (thisArg, argList) {
    ...
    if (literalSegments <= 0) return NormalCompletion("");
    var stringElements = [];
    var nextIndex = 0;
    for (;;) {
...
var StringPrototype_$$iterator = function iterator(thisArg, argList) {
    return CreateStringIterator(thisArg, "value");
};
var StringPrototype_entries = function entries(thisArg, argList) {
